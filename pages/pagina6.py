...
dash.register_page(__name__, path='/Clase_6', name='Clase_6')
...
layout= html.Div([
    ...
    html.Div([
     ...
     html.Div([
         html.Label("Tasa de recuperacion (ɣ):"),
...
def simular_sir(n_clicks, N, beta, gamma, I0, tiempo_max):
    ...
    try:
        solucion= odeint(modelo_sir, y0, t, args=(N, beta, gamma))
        S, I, R= solucion.T
